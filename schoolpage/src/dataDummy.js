...
export const dataDummy = [
    ...
    },
    {
        ...
        applicationMethod : "구글폼 작성(https://..) " ,
        explanation: "민족예술연구회에 여러분을 초대합니다! 우리는 탈춤, 마당극, 풍물을 사랑하고 연구하는 동아리입니다. 전통이라는 큰 나무 아래서, 우리는 우리 고유의 문화와 예술을 이해하고, 배우며, 연구합니다. 우리 동아리는 탈춤과 마당극, 풍물에 대한 열정을 가진 학우들이 모였습니다. 함께 이런 예술을 배우고자 하는 분들을 찾습니다. 신입생, 재학생, 대학원생, 누구든지 참여할 수 있습니다. 예술에 대한 사랑과 호기심만 있으면 됩니다. 우리 동아리의 주요 행사는 대동제 공연입니다. 이 공연을 통해 우리는 우리의 연습과 배움을 펼치고, 학우들과 공유합니다. 또한, 다양한 행사와 공연을 통해 우리는 풍물인구의 확대를 꾀하고 있습니다. 민족예술연구회에서는, 우리의 전통을 이해하고, 사랑하며, 연구하는 시간을 가집니다. 함께 우리의 뿌리를 찾아가는 여행에 참여해 보세요. 민족예술연구회는 여러분의 참여를 기다립니다."
    },
    {
        filter: "교내동아리",
        intro_crewName: "왕산악",
    ...
    },
    {
        ...
        membershipFee: "15000원", 
        applicationMethod : "구글폼 작성(https://..) " ,
        explanation: "전국 1위! 2만 명이 선택한 맛집탐방 동아리 미팅놈들 7기 모집 세상에 없던 플랫폼, 세상에 없던 즐거움!"
    },
    {
        filter: "연합동아리",
        intro_crewName: "DoIt",
